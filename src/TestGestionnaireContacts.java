...
// Ajout de contacts
        gestionnaire.ajouterContact(new Contact("Dupont", "Jean", "0123456789", "jean.dupont@example.com")); gestionnaire.ajouterContact(new Contact("Martin", "Alice", "9876543210", "alice.martin@example.com"));
